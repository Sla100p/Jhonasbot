...
// INÍCIO DS FUNÇÃO jhonas 
async function jhonas() {
    ...
    client.ev.on('messages.upsert', connection => {
        ...
        require('./jhonas.js')(client, info, settings, color)
    });
...
// start no bot...
jhonas(), (err) => console.log("vix boy, deu erro", color(String(err), 'red'));
